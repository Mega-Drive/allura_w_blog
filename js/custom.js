...
$(document).ready(function()
{
	...
	*/
	...
	{
		$('.home_background').parallax({imageSrc: 'images/home_background.jpg'});
		$('.stats_background').parallax({imageSrc: 'images/stats_background.jpg'});
		$('.blog_background').parallax({imageSrc: 'images/blog_background.jpg'});
		$('.blog_single_background').parallax({imageSrc: 'images/blog_single_background.jpg'});
	}
